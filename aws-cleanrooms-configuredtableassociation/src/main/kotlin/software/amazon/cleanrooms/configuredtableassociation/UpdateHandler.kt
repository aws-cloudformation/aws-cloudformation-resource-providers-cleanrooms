...
class UpdateHandler : BaseHandler<CallbackContext?>() {
    override fun handleRequest(
        ...
        logger.log("Inside UPDATE handler for ConfiguredTableAssociation resource. Request AWS AccountId:$requestAccountId")
        ...
        return try {
            ...
            logger.log("UpdateHandler ConfiguredTableAssociationIdentifier from resourceModel: ${desiredResourceModel.configuredTableAssociationIdentifier}")


            logger.log("Updating ConfiguredTableAssociation")
            updateConfiguredTableAssociation(desiredResourceModel, proxy, cleanRoomsClient)
