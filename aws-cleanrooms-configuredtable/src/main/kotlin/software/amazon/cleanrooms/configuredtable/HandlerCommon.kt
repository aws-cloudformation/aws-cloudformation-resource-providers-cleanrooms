...
object HandlerCommon {
    ...
    fun verifyListResourceFound(
        ...
        val isPrimaryIdFoundInList = resourceModelList.any { it.configuredTableIdentifier == primaryIdentifier }
        logger.log("Resource $primaryIdentifier found in ListHandler response: $isPrimaryIdFoundInList")
        return isPrimaryIdFoundInList
    }
