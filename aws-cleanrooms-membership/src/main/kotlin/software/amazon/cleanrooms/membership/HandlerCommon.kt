...
object HandlerCommon {
    ...
    fun verifyListResourceFound(
        ...
        val primaryIdentifier = request.desiredResourceState.getMembershipIdFromPrimaryIdentifier()
        ...
        return resourceModelList.any { it.membershipIdentifier == primaryIdentifier }.also {
