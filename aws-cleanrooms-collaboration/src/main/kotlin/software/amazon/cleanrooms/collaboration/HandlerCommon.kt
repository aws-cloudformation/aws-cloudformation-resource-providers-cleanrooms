...
object HandlerCommon {
    ...
    fun verifyListResourceFound(
        ...
        val primaryIdentifier = request.desiredResourceState.getCollaborationIdFromPrimaryIdentifier()
        ...
        return resourceModelList.any { it.collaborationIdentifier == primaryIdentifier }.also {
            logger.log("Resource $primaryIdentifier found in ListHandler response: $it")
        }
    }
